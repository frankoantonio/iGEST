...
--
CREATE INDEX ON gen.tipo (grupo);
CREATE INDEX ON gen.tipo (grupo,clave);
--
COMMENT ON TABLE gen.tipo IS 'Tabla de tipos multiusos.'; 
COMMENT ON COLUMN gen.tipo.id_tipo IS 'Identificador de gen.tipo.';
COMMENT ON COLUMN gen.tipo.nom_tipo IS 'Nombre del gen.tipo.';
COMMENT ON COLUMN gen.tipo.nom_corto IS 'Nombre corto del gen.tipo.';
COMMENT ON COLUMN gen.tipo.cod_oficial1 IS 'Código oficial. Ejm: SUNAT.';
COMMENT ON COLUMN gen.tipo.cod_oficial2 IS 'Código oficial.';
COMMENT ON COLUMN gen.tipo.valor1 IS 'Algún valor necesario. Ejm: DNI=8.';
COMMENT ON COLUMN gen.tipo.valor2 IS 'Algún valor necesario.';
COMMENT ON COLUMN gen.tipo.clave IS 'Clave para el diccionario de datos.';
COMMENT ON COLUMN gen.tipo.grupo IS 'Nombre para agrupar gen.tipo.';
COMMENT ON COLUMN gen.tipo.orden IS 'Orden en que se muestran.';
COMMENT ON COLUMN gen.tipo.activo IS 'Si el gen.tipo está activo.';
COMMENT ON COLUMN gen.tipo.id_sistema IS 'Identificador del gen.sistema [SISTEMA].';
COMMENT ON COLUMN gen.tipo.descripcion IS 'Descripción del gen.tipo.';
--
...
--
COMMENT ON TABLE empresa IS 'Empresas que utilizan este gen.sistema.'; 
...
COMMENT ON COLUMN var_global.id_sistema IS 'Identificador del gen.sistema [gen.sistema].';
...
COMMENT ON COLUMN empresa_sistema.id_sistema IS 'Identificador de gen.sistema [SISTEMA].';
COMMENT ON COLUMN empresa_sistema.activo IS 'Sí el gen.sistema está activo para la empresa.';
-----------------------hhhh
-----------------------hhhhh
--
...
COMMENT ON COLUMN sede.id_tipo_sede  IS 'Identificador del gen.tipo de sede [TI_SEDE].';
...
--
COMMENT ON TABLE acceso IS 'Registro de accesos al gen.sistema.'; 
...
COMMENT ON COLUMN acceso.id_tipo_usu  IS 'Identificador del gen.tipo de usuario [TI_GRP_USU].';
