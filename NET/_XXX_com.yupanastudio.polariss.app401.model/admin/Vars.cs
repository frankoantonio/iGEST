...
namespace com.yupanastudio.polariss.app
{
    ...
    {
        // PRECARGA
        public static List<Empresa> lsEmpINI;           // se inicializa en el proyecto de cada empresa      
        public static Empresa obEmpINI;                 // para obtener sus imágenes asociados 
        public static int minCar = 6;                   // mínimo de caracteres exigidos, puede cambiar al cargar variables
        public static string urlServer = "localhost";
        public static int urlServerPort = 443;
        public static string urlServerApp = "https://localhost/ws";
        public static HttpClient client;                // para conectarse con el API REST
        ...
        public static List<Sistema> lsSistemasEmp;      // sistemas habilitados para la empresa
        public static List<Sede> lsSedesEmp;            // sedes de la empresa    
        public static List<Sistema> lsSistemasUsu;      // sistemas habilitados para el usuario
        public static List<Perfil> lsPerfilUsu;         // perfiles habilitados para el usuario
        ...
        public static List<Departamento> lsDptos;       // lista de departamentos
        public static List<Provincia> lsProvs;          // lista de provincias
        public static List<Distrito> lsDists;           // lista de distritos
        public static List<Tipo> lsTipos;               // lista de tipos
        public static List<VarGlobal> lsVarGlobal;      // lista de variable globales
        ...
        public static DateTime feUsuario;                                                       // fecha y hora del trabajador
        public static DateTime feOperacion;
        public static bool cambioFecha;                                                         // determina si cambio la fecha
