...
namespace com.yupanastudio.polariss.app
{
    public partial class FrmMaster : Form
    {
        ...
        public void setPermisos()
        {
            ...
            //{
            //    var tag = btn.Tag?.ToString();
            //    if ((obPerfil.nuevoX == false && tag == "btnNUEVO") || (obPerfil.modificarX == false && tag == "btnMODIFICAR") ||
            //        (obPerfil.eliminarX == false && tag == "btnELIMINAR") || (obPerfil.imprimirX == false && tag == "btnIMPRIMIR") || tag == "btnSAVE")
            //        btn.Enabled = false;
            //    else
            //        btn.Enabled = (tag == "---");
            //}           
