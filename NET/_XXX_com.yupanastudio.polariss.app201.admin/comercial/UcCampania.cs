...
namespace com.yupanastudio.polariss.app
{
    public partial class UcCampania : UcMaster
    {
        ...
        private void UcCampania_Load(object sender, EventArgs e)
        {
            ...
            ////////dgvCamp_idTipoPeriodo.DataSource = Vars.lsTipos.Where(x => x.grupo == "TI_PERIODICIDAD").ToList();
            ////////dgvCamp_idTipoModEst.DataSource = Vars.lsTipos.Where(x => x.grupo == "TI_MOD_ESTUDIO").ToList();
            ////////dgvCamp_idTipoTurno.DataSource = Vars.lsTipos.Where(x => x.grupo == "TI_TURNO").ToList();
            ...
            //////nudAnio.Value = Vars.feOperacion.Year;
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else if (lsCampanias[dgvCampanias.CurrentRow.Index].anio < Vars.feOperacion.Year)
            {
