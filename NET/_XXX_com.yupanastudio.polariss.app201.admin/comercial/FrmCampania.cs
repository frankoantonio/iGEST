    ...
    public partial class FrmCampania : FrmMaster
    {
        ...
        private void FrmCampania_Load(object sender, EventArgs e)
        {
            ...
            else if (xOperCRUD == CRUD.NEW)
            {
                ...
                dtpIni.Value = new DateTime(Vars.feOperacion.Year, 1, 1);
                dtpFin.Value = new DateTime(Vars.feOperacion.Year, 1, 1);
        ...
        private void habilitarCtrl(bool b)
        {
            ...
            cmbTurno.SelectedItem = null;
            cmbTipoIns.SelectedItem = null;
            dtpIniClas.Value = new DateTime(Vars.feOperacion.Year, 1, 1);
            dtpFinClas.Value = new DateTime(Vars.feOperacion.Year, 1, 1);
        ...
        private bool validarCtrls()
        {
            ...
            if (nudAnio.Value < Vars.feOperacion.Year || nudAnio.Value >= Vars.feOperacion.Year + 2)
            {
