...
namespace com.yupanastudio.polariss.app
{
    public partial class UcGbVars : UcMaster
    {
        ...
        {
            cmbVarGb.DataSource = Vars.lsVarGlobal.OrderBy(x => x.idSistema).ThenBy(y => y.nomVarGb).ToList();
            cmbEmpresa.DataSource = (await EmpresaBridge.getEmpresaAllWithoutChild()).OrderBy(x => x.nomComercial).ToList();
        }
