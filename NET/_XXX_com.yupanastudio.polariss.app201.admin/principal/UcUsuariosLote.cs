...
{
    public partial class UcUsuariosLote : UcMaster
    {
        private Empresa obEmp;
        private Negocio obNeg;

        public UcUsuariosLote()
        {
            InitializeComponent();
        }
        ...
        {
            List<Empresa> lsEmp = await EmpresaBridge.getEmpresaAllWithChild();
        ...
        private async void cmbNegocio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    dgvSedes.DataSource = await NegocioSedeBridge.getNegocioSedeByNeg(obEmp.idEmpresa, obNeg.idEmpresa);
        ...
        private async void btnOkSede_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        dgvSedes.DataSource = await NegocioSedeBridge.save(obEmp.idEmpresa, obNeg.idEmpresa, dgvSedes.DataSource as List<NegocioSede>);
        ...
        private void btnSelPer_Click(object sender, EventArgs e)
        {
            //FrmPersonaFind frm = new FrmPersonaFind(CRUD.SELECT, true, true);
            //frm.soloLEstura(true);
            //frm.ShowDialog();
            //new FrmPersonaFind(true, CRUD.SELECT, true).ShowDialog();

            //new FrmPersonaFind(true, CRUD.SELECT, this.obOpcion.soloLectura).ShowDialog();
        }
