...
namespace com.yupanastudio.igest.winapp
{
    public class PersonaBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/adm/persona/{idPersona}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/admin/persona/by_doc_ident/{idEmpresa}/{numDoc}/{idTipoPersona}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/admin/persona/by_nom_ape_rz_soc/{idEmpresa}/{nomApeRzSoc}/{idTipoPersona}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/gen/persona/fams_all/{idGrpFam}/{idPersona}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/gen/persona/by_grp_fam/{idGrpFam}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.PutAsJsonAsync(Vars.urlServerApp + "/adm/persona", obPersona);
