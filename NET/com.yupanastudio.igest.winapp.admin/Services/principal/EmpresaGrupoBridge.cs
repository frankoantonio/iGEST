...
namespace com.yupanastudio.polariss.app
{
    public class EmpresaGrupoBridge
    {
        ...
        //{
        //    HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + "/gen/empresa_grupo");
        ...
        //{
        //    HttpResponseMessage response = await Vars.httpClient.PostAsJsonAsync(Vars.urlServerApp + "/gen/empresa_grupo", obEmp);
        //    response.EnsureSuccessStatusCode();
        ...
        //{
        //    HttpResponseMessage response = await Vars.httpClient.PutAsJsonAsync(Vars.urlServerApp + "/gen/empresa_grupo", obEmp);
        //    response.EnsureSuccessStatusCode();
        //    return await response.Content.ReadAsAsync<EmpresaGrupo>();
        //}
