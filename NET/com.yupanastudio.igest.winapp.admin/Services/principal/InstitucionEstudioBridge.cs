...
namespace com.yupanastudio.igest.winapp
{
    public class InstitucionEstudioBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/gen/institucion_estudio/by_noms/{find}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/gen/institucion_estudio/{idInstEst}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.PutAsJsonAsync(Vars.urlServerApp + "/gen/institucion_estudio", obInstEstudio);
