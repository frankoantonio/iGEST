...
namespace com.yupanastudio.igest.winapp
{
    public class GradoBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/acd/grado/{idNivEdu}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.PutAsJsonAsync(Vars.urlServerApp + "/acd/grado", obGrado);
