...
namespace com.yupanastudio.igest.winapp
{
    public class ProductoSunatBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/producto_sunat/{idProdSunat}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/producto_sunat/by_find/{find}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/producto_sunat/by_nivel/{nivel}/{codPadre}");
