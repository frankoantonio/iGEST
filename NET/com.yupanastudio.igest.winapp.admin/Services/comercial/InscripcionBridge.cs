...
namespace com.yupanastudio.igest.winapp
{
    public class InscripcionBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/inscripcion/by_estudiante/{idEstudiante}/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.PutAsJsonAsync(Vars.urlServerApp + "/com/inscripcion", obInsc);
