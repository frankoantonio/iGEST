...
namespace com.yupanastudio.igest.winapp
{
    public class CampaniaBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/campania/{idCampania}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/campania/by_negocio_activo/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.GetAsync(Vars.urlServerApp + $"/com/campania/by_negocio_anio/{idNegocio}/{anio}");
        ...
        {
            HttpResponseMessage response = await Vars.httpClient.PutAsJsonAsync(Vars.urlServerApp + "/com/campania", obCampania);
