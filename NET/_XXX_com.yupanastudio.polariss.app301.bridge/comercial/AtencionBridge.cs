...
namespace com.yupanastudio.polariss.app
{
    public class AtencionBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/atencion/{idInforme}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/com/atencion", obAtencion);
