...
namespace com.yupanastudio.polariss.app
{
    ...
    {        
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/beneficio/{idNegocio}");
        ...
        //{
        //    HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/com/Beneficio", obBeneficio);
