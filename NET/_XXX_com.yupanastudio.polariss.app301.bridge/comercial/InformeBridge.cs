...
namespace com.yupanastudio.polariss.app
{
    public class InformeBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/informe/{idInforme}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/informe/by_persona/{idPersona}/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/informe/by_persona_activo/{idPersona}/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/informe/by_sede_estado/{idSede}/{idTipoEstado}/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/com/informe", obInforme);
