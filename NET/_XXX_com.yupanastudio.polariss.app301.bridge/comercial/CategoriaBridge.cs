...
namespace com.yupanastudio.polariss.app
{
    public class CategoriaBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/categoria/by_negocio/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/com/categoria", obCategoria);
