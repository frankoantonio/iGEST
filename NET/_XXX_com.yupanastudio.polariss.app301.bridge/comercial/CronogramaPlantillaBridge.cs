...
namespace com.yupanastudio.polariss.app
{
    public class CronogramaPlantillaBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/com/cronograma_plantilla/{idCampania}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/com/cronograma_plantilla", lsCronograma);
