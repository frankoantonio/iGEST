...
namespace com.yupanastudio.polariss.app
{
    public class EmpresaBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + "/gen/empresa/all_with_child");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + "/gen/empresa/all_without_child");
