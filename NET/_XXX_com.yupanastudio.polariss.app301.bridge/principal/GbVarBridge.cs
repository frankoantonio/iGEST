...
namespace com.yupanastudio.polariss.app
{
    public class GbVarBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/gbvar/by_nombre/{nomGbVar}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/gbvar/by_empresa/{idEmpresa}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PostAsJsonAsync(Vars.urlServerApp + "/gen/gbvar", "");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/gen/gbvar", lsGbVar);
