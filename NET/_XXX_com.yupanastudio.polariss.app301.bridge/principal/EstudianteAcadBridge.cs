...
namespace com.yupanastudio.polariss.app
{
    public class EstudianteAcadBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/estudiante_acad/{idEstAcad}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/gen/estudiante_acad", obEstAcad);
