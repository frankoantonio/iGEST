...
namespace com.yupanastudio.polariss.app
{
    public class TrabajadorBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/admin/trabajador/{idTrabajador}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/lab/trabajador", obTrab);
        ...
        //{
        //    HttpResponseMessage response = await Vars.client.PostAsJsonAsync(Vars.urlServerApp + "/lab/trabajador", obTrab);
