...
namespace com.yupanastudio.polariss.app
{
    public class SedeBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/sede/by_empresa/{idEmpresa}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/sede/by_persona/{idPersona}");
