...
namespace com.yupanastudio.polariss.app
{
    public class GrupoFamiliarBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/grupo_familiar/{idGrpFam}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/grupo_familiar/by_noms/{idEmpresa}/{find}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/gen/grupo_familiar", obGrpFam);
