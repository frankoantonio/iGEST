...
namespace com.yupanastudio.polariss.app
{
    public class FamiliarBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/familiar/{idFam}/{idEst}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/familiar/by_est_grp/{idGrpFam}/{idEst}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/gen/familiar", obFam);
