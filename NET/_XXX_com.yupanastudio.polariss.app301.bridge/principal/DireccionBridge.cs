...
namespace com.yupanastudio.polariss.app
{
    public class DireccionBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/direccion/{idDireccion}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/direccion/by_noms/{idEmpresa}/{nomVia}");
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/gen/direccion/by_fams_all/{idPersona}/{idGrpFam}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/gen/direccion", obDir);
