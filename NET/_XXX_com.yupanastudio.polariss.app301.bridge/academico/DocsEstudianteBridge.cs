...
namespace com.yupanastudio.polariss.app
{
    public class DocsEstudianteBridge
    {
        ...
        {
            HttpResponseMessage response = await Vars.client.GetAsync(Vars.urlServerApp + $"/acd/docs_estudiante/{idEstudiante}/{idNegocio}");
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/acd/docs_estudiante/recibir", lsDocsEst);
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/acd/docs_estudiante/actualizar", lsDocsEst);
        ...
        {
            HttpResponseMessage response = await Vars.client.PutAsJsonAsync(Vars.urlServerApp + "/acd/docs_estudiante/devolver", lsDocsEst);
