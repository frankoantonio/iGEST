...
import com.yupanastudio.igest.server.principal.service.PerfilService;
...
//    @Autowired
//    PerfilService obPerfilService;

//    @GetMapping("/{idUsuario}")
//    public ResponseEntity<List<Perfil>> getPerfilByIdUsuario(@PathVariable long idUsuario) {
//        try {
//            System.out.println("Controller_____________");
//            return new ResponseEntity<>(obPerfilService.getPerfilByIdUsuario(idUsuario), HttpStatus.OK);
//        } catch (Exception ex) {
